...
const products = [{ "title": "Apple", 
		...
		{ "title": "C-Design Lab", 
		 ...
		 { "title": "Indian Institute of Technology, Hyderabad", 
					"description" : "Research Associate for Dr.Amirtham Rajagopal, Civil Engineering", 
					"banner" : "https://i.imgur.com/6ShqZml.png", 
					"url" : "likewallet.html"},
		 { "title": "Nuclear Fuel Complex- Department of Atomic Energy", 
					"description" : "Mechanical Engineering Intern for NFC's Zircaloy Fabrication Plant (ZFP)", 
					"banner" : "https://i.imgur.com/MsyHmPP.jpg", 
					"url" : "likewallet.html"}];
